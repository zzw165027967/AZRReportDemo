 ...
 */
function drawReport08Visualization()
{
	// Create and populate the data table.
	var data = new google.visualization.DataTable({
		cols : [{ id : '', label : 'Periode', type : 'string'
			}, { id : '', label : 'Year', type : 'string'
			}, { id : '', label : 'Verzender (AW34)', type : 'string'
			}, { id : '', label : 'Ontvanger (AW34)', type : 'string'
    ...
    // Maak een filter aan voor 'Ontvanger'
    var filter3 = new google.visualization.ControlWrapper(addDefaultDropdownSelector({ 'containerId': 'divfilter3', 'options': { 'filterColumnLabel': 'Verzender (AW34)'} }));
    // Maak een filter aan voor 'Ontvanger'
    var filter4 = new google.visualization.ControlWrapper(addDefaultDropdownSelector({ 'containerId': 'divfilter4', 'options': { 'filterColumnLabel': 'Ontvanger (AW34)'} }));
    // Maak een filter aan voor 'Type'
